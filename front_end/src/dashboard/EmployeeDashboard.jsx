...
const Dashboard = () => {
  ...
  return (
    <div
      className="p-6 bg-[#f2f4f5] text-gray-800 shadow-md  
        dark:bg-neutral-900 dark:text-white min-h-screen"
    >
      {/* Dashboard Heading */}
        ...
        <div className=" rounded-lg shadow-md p-4">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm ">SDE I • Development</p>
            </div>
          </div>
          <p>
          ...
          <p>
            <strong>Joining Date:</strong> 2025-08-19
          </p>
        </div>
